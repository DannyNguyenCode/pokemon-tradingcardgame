...
export default async function NavBar() {
    ...
    return (
        <div className="navbar sticky top-0 z-[100] h-16 min-h-16 shrink-0 bg-base-100 shadow-sm">
            {/* lg:pointer-events-none so the logo strip does not sit on top of the centered nav (Catalog was unclickable). Interactive children opt back in. */}
            <div className="navbar-start z-10 flex-1 items-center lg:pointer-events-none lg:absolute lg:left-0 lg:top-0 lg:flex-none lg:h-16 lg:px-2">
                ...
                <Link href={'/'} className="link link-hover link-active pointer-events-auto text-xl items-center hidden lg:flex gap-2 p-4">
            ...
            <div className="navbar-center hidden w-full flex-1 justify-center lg:flex">
                <ul className="menu menu-horizontal flex-nowrap justify-center px-1">
                    <li><Link role="link" href={'/'} aria-label="redicrect to home page">Home</Link></li>
